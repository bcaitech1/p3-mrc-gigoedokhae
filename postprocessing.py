...
mecab = Mecab('/opt/conda/mecab/dic')
with open('/opt/ml/pycharm/outputs/xlmroberta0506/top_8_1e-05_4_384_pre_passagetop20/predictions_post.json') as pr:
    predictions = json.load(pr)
with open('/opt/ml/pycharm/outputs/xlmroberta0506/top_8_1e-05_4_384_pre_passagetop20/nbest_predictions.json') as nb:
...
with open('/opt/ml/pycharm/outputs/xlmroberta0506/top_8_1e-05_4_384_pre_passagetop20/post_processing.json', 'w') as fp:
